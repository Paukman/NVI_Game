...
const CheckCircleSuccessSVG = () => {
  return (
    <svg width="16px" height="16px" fill="#52c41a" viewBox="0 0 1024 1024">
...
const CheckCircleSuccess = props => (
  <Icon component={CheckCircleSuccessSVG} {...props} />
);
