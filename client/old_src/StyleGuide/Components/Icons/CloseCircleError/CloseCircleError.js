...
const CloseCircleErrorSVG = () => {
    return (
        <svg width="16px" height="16px" fill="#eb0042" viewBox="0 0 1024 1024">
...
const CloseCircleError = props => <Icon component={CloseCircleErrorSVG} {...props} />;
